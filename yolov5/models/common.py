...
class DecoupledHead(nn.Module):
    ...
    def __init__(self, ch=256, nc=50, anchors=()):
        ...
        self.cls_preds = DWConvTranspose2d(ch, self.nc * self.na, 1)  # 一个1x1的卷积，把通道数变成类别数，比如coco 80类（主要对目标框的类别，预测分数）
        self.reg_preds = DWConvTranspose2d(ch, 4 * self.na, 1)  # 一个1x1的卷积，把通道数变成4通道，因为位置是xywh
        self.obj_preds = DWConvTranspose2d(ch, 1 * self.na, 1)  # 一个1x1的卷积，把通道数变成1通道，通过一个值即可判断有无目标（置信度）
